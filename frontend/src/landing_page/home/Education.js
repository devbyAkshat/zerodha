    ...
    <div className='container mt-5 p-5'>
        <div className='row'>
            ...
            <div className='col-6 p-5'>
                ...
                <a href=''  style={{textDecoration:"none"}}>Varsity <i class="fas fa-long-arrow-alt-right"></i></a>

                <p className='mt-4'>TradingQ&A, the most active trading and investment community 
                    in India for all your market related queries.
                </p>
                <a href=''  style={{textDecoration:"none"}}>TradingQ&A <i class="fas fa-long-arrow-alt-right"></i></a>
