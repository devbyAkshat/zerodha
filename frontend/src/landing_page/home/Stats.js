        ...
        <div className='row p-5'>
            ...
            <div className='col-6'>
                ...
                <div className='text-center'>
                    ...
                    <a href=''  style={{textDecoration:"none"}}>Try kite demo <i class="fas fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
